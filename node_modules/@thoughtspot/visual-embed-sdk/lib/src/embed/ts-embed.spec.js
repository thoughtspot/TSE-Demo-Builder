...
import { AuthType, init, EmbedEvent, SearchEmbed, PinboardEmbed, AppEmbed, LiveboardEmbed, } from '../index';
...
describe('Unit test case for ts embed', () => {
    ...
    describe('when thoughtSpotHost have value and authPromise return success response', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(baseInstance, 'getAuthPromise').mockResolvedValueOnce(() => Promise.resolve());
    ...
    describe('when thoughtSpotHost have value and authPromise return error', () => {
        ...
        beforeEach(() => {
            jest.spyOn(baseInstance, 'getAuthPromise').mockRejectedValueOnce(() => Promise.reject());
            const tsEmbed = new SearchEmbed(getRootEl(), {});
            const iFrame = document.createElement('div');
            iFrame.contentWindow = null;
            jest.spyOn(document, 'createElement').mockReturnValueOnce(iFrame);
    ...
    describe('Naviage to Page API', () => {
        ...
        test('when app is PinboardEmbed after navigateToPage function call, new path should be set to iframe', async () => {
            ...
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true&${defaultParamsForPinboardEmbed}&isLiveboardEmbed=true#/embed/${path}`);
        });
    ...
    describe('additionalFlags config', () => {
        ...
        it('should set the additional flags correctly on the iframe src', async () => {
            ...
            await appEmbed.render();
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true&primaryNavHidden=true&profileAndHelpInNavBarHidden=false&${defaultParamsForPinboardEmbed}` +
